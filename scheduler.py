...
if options.solve == True:
  ...
  if options.policy == 'STCF':
    ...
    for job in joblist:
      ...
      ### DO NOT FORGET TO CONVERT THE STRINGS BACK TO INTS ANDREW
    ...
    for e in joblist:
      ...
      print(runlist)
    while jobcount > 0:
      runlist = sorted(runlist, key=lambda x: x[2])  # Sorts the list by Start time
      '''
      The sort is really important. It makes the rest of the problem much easier, because now we know 
